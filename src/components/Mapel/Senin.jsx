    ...
    return (
			<>
				...
				<div className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60" data-aos="fade-up" data-aos-duration="600">
					<div className="w-[50%] text-base  font-medium">PKK</div>
					<div className="flex justify-center items-center text-sm">07.40-09.00</div>
				</div>
				<div className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="700">
					<div className="w-[50%] text-base  font-medium">Bahasa Jawa</div>
					<div className="flex justify-center items-center text-sm">09.00-09.40</div>
				</div>
				...
				<div className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60" data-aos="fade-up" data-aos-duration="900">
					<div className="w-[50%] text-base  font-medium">Bahasa Jawa</div>
					<div className="flex justify-center items-center text-sm">10.00-10.40</div>
				</div>
				<div className="border-t-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="1000">
					<div className="w-[50%] text-base font-medium">Ismuba 1</div>
					<div className="flex justify-center items-center text-sm">10.40-12.00</div>
				</div>
